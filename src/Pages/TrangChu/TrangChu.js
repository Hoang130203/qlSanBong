...
function TrangChu() {
    ...
    return (
        <Grid container width='100%' justifyContent='center' >
            ...
            <Grid item container display='flex' flexDirection='row' justifyContent='center' alignItems='center'>
                ...
                <Grid item container md={9} xs={10} height='auto' padding='0px 10px'>
                    <img src="https://mona.media/wp-content/uploads/2021/06/banner-giay.png" style={{ width: '100%', height: 'auto', borderRadius: '10px' }} />
                </Grid>
