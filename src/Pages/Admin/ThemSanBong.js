...
import { Button, Grid, MenuItem, Select, TextField, TextareaAutosize, Typography, createTheme } from "@mui/material";
        ...
        <Grid item container spacing={1} style={{ padding: " 30px 50px" }} xs={12} width='100%'>
            <ThemeProvider theme={theme}>
                ...
                <Grid item container xs={12} rowSpacing={1} >
                    ...
                    <Grid item container xs={12} alignItems='center'>
                        ...
                        <Grid item xs={12} md={7}>
                            <Select style={{ width: '120px', height: '45px' }} value={type} onChange={onChange}>
                                ...
                                <MenuItem value='fusal'>Fusal</MenuItem>
                            </Select>
                        </Grid>
                    </Grid>
                    <Grid item container xs={12} alignItems='center'>
                        ...
                        <Grid item xs={12} md={7}>
                            <TextareaAutosize style={{ width: '430px', height: '70px', fontSize: '20px', fontFamily: 'inherit', padding: '5px' }} />
                        </Grid>
                    </Grid>
                    ...
                    <Grid item xs={12} >
                        <Button variant="contained" startIcon={<AddIcon />}><Typography textTransform='none'>Thêm sân bóng</Typography></Button>
                    </Grid>
                </Grid>
            </ThemeProvider>
        </Grid>
